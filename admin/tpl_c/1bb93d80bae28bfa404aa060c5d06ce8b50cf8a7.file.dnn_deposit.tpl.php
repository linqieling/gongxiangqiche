<?php /* Smarty version Smarty-3.1.13, created on 2020-12-15 11:30:11
         compiled from "./admin/tpl/dnn_deposit.tpl" */ ?>
<?php /*%%SmartyHeaderCode:90983695fd82dc3ed0f91-91380838%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1bb93d80bae28bfa404aa060c5d06ce8b50cf8a7' => 
    array (
      0 => './admin/tpl/dnn_deposit.tpl',
      1 => 1555308956,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '90983695fd82dc3ed0f91-91380838',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_5fd82dc3f04251_20093380',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fd82dc3f04251_20093380')) {function content_5fd82dc3f04251_20093380($_smarty_tpl) {?> 
...
layui.use(['table','jquery','laydate','dialog'], function(){
  var form = layui.form,
     ...
     //日期时间选择器
      ...
      table.render({
         elem: "#order"
        ,url:"admin.php?view=dnn_deposit&op=list_api"
        ,toolbar: '#toolbarDemo'
        ,title: "押金管理"
        ,totalRow:true
        ,cols: [[
          ...
          ,{field:'type', title:'类型', width:80,templet: function(res){
             var type='';
             if(res.type=='1'){
                type='<b style="color:#F581B1">支付</b>';
             }else if(res.type=='2'){
                type='<b style="color:#01AAED">退还</b>';
             }
             return type;
          }}
          ,{field:'title', title:'说明', width:300}
          ,{field:'dateline', title:'下单时间', width:180}
      ...
      $('#export').click(function() {}).mouseenter(function() {
          dialog.tips('未选择数据表示导入全部押金明细', '#export');
      })
      table.on('toolbar(order)', function(obj){
          ...
          switch(obj.event){
            case 'export':
              ...
              var url='/admin.php?view=dnn_deposit&op=export&ids='+ids;
