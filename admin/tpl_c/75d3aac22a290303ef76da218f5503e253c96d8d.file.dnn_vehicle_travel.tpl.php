<?php /* Smarty version Smarty-3.1.13, created on 2020-12-16 11:13:20
         compiled from "./admin/tpl/dnn_vehicle_travel.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1067742225fd97b50462045-60769550%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '75d3aac22a290303ef76da218f5503e253c96d8d' => 
    array (
      0 => './admin/tpl/dnn_vehicle_travel.tpl',
      1 => 1550384720,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1067742225fd97b50462045-60769550',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5fd97b504d4dc8_23502422',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fd97b504d4dc8_23502422')) {function content_5fd97b504d4dc8_23502422($_smarty_tpl) {?><!DOCTYPE html>
<html>
...
<body>
   <div id="result"></div>
    ...
    <script>
            ...
            //请求接口---------------------------
            $.ajax({
                    url: "/admin.php?view=dnn_vehicle_travel&op=api&oid=<?php echo $_smarty_tpl->tpl_vars['oid']->value;?>
",
                    type:'GET',
                    dataType: 'json',
                    async:false,
                    ...
                    complete:function (argument) {
                        ...
                        var label = new BMap.Label("<?php echo $_smarty_tpl->tpl_vars['order']->value['platenumber'];?>
",{offset:new BMap.Size(0,-45)});
            ...
            if(arrPois!=''){
              lushu = new BMapLib.LuShu(map,arrPois,{
                  defaultContent:"<?php echo $_smarty_tpl->tpl_vars['order']->value['platenumber'];?>
",//"从天安门到百度大厦"
