<?php /* Smarty version Smarty-3.1.13, created on 2020-12-15 12:06:16
         compiled from "./admin/tpl/dnn_config.tpl" */ ?>
<?php /*%%SmartyHeaderCode:21214562235fd83638567339-33401191%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '89195a0928dcd483bf8143ed661f06d4c4f32224' => 
    array (
      0 => './admin/tpl/dnn_config.tpl',
      1 => 1585742394,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '21214562235fd83638567339-33401191',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5fd836385f6599_08652137',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fd836385f6599_08652137')) {function content_5fd836385f6599_08652137($_smarty_tpl) {?>
...
">
      ...
      <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
          <input type="text" name="config[grantdate]" maxlength="2" placeholder="请输入优惠券发放日" autocomplete="off" class="layui-input number" value="<?php echo $_smarty_tpl->tpl_vars['configs']->value['grantdate'];?>
" />
        </div>
 ...
 $_from = $_smarty_tpl->tpl_vars['coupon_list']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['list']->key => $_smarty_tpl->tpl_vars['list']->value){
$_smarty_tpl->tpl_vars['list']->_loop = true;
?>
          <div class="layui-btn-group">
            <div class="layui-btn layui-btn-sm">满<?php echo $_smarty_tpl->tpl_vars['list']->value['money'];?>
元 发放<?php  $_smarty_tpl->tpl_vars['datalist'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['datalist']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['list']->value['coupon']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['datalist']->key => $_smarty_tpl->tpl_vars['datalist']->value){
$_smarty_tpl->tpl_vars['datalist']->_loop = true;
?>【<?php echo $_smarty_tpl->tpl_vars['datalist']->value['name'];?>
(<?php echo $_smarty_tpl->tpl_vars['datalist']->value['number'];?>
张)】<?php } ?></div>
            <div class="layui-btn layui-btn-sm" onclick="del_cid(this,<?php echo $_smarty_tpl->tpl_vars['list']->value['id'];?>
