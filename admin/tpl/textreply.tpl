...
<div class="wrap-container clearfix">
        <div class="column-content-detail">
          <form action='admin.php' method='get' class="layui-form">
            <input type="hidden" name="view" value="textreply">
          ...
          <form method="post" action="admin.php?view=textreply&op=[##$op##]" enctype="multipart/form-data"  class="layui-form" id="table-list"  >
          <input type="hidden" name="formhash" value="[##$_SGLOBAL.formhash##]" />

                <div class="layui-tab layui-tab-card">
                  <ul  class="layui-tab-title">
                    <li><a href="admin.php?view=appmsgreply">图文消息</a></li>
                    <li class="layui-this"><a href="admin.php?view=textreply">文字消息</a></li>
                        ...
                        <tbody>
                                [##section name=loop loop=$datalist##]
                                  <tr [##if $smarty.section.loop.index is even##] class="even"[##/if##]>
                                    ...
                                    <td>
                                      <a href="admin.php?view=textreply&op=edit&id=[##$datalist[loop].id##]">编辑</a>
                                      &nbsp;<a href="admin.php?view=textreply&op=del&id=[##$datalist[loop].id##]" onClick="return confirm('本操作不可恢复，确认删除？');">删除</a>
                                    </td>
                                  </tr>
                                  [##sectionelse##]
                                  <tr>
                                   ...
                                   <tr>
                                      <td  colspan="8" align='left'>
                                             <div class="layui-btn-group">
                                               <input type="button" onclick="javascript:window.location.href='admin.php?view=textreply&op=add'" value="增加" class="layui-btn  layui-btn-sm" >
                                               <input type="button"  onclick="javascript:window.location.href='admin.php?view=textreply'" value="全部" class="layui-btn  layui-btn-sm">
...
<form method="post" action="admin.php?view=textreply&op=[##$op##]" enctype="multipart/form-data"  >
  <input type="hidden" name="formhash" value="[##$_SGLOBAL.formhash##]" />
  <input type="hidden" name="refer" value="[##$_SGLOBAL.refer##]" />
  <input type="hidden" name="id" value="[##$result.id##]" />
  <fieldset class="layui-elem-field layui-field-title" >
    <legend>微信文本回复管理</legend>
  </fieldset>
        <div class="layui-tab-item layui-show">
          <div class="layui-form  layui-form-pane" style="margin:1rem;">
              ...
              <div class="layui-form-item layui-form-text">
                ...
                <div class="layui-input-block">
                  <textarea placeholder="请输入内容" class="layui-textarea" name="content">[##$result.content##]</textarea>
                </div>
              </div>
