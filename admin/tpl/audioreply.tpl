...
<div class="wrap-container clearfix">
        <div class="column-content-detail">
          <form action='admin.php' method='get' class="layui-form">
            <input type="hidden" name="view" value="audioreply">
          ...
          <form method="post" action="admin.php?view=audioreply&op=[##$op##]" enctype="multipart/form-data"  class="layui-form" id="table-list"  >
          <input type="hidden" name="formhash" value="[##$_SGLOBAL.formhash##]" />
                ...
                <div class="layui-tab layui-tab-card">
                  <ul  class="layui-tab-title">
                    ...
                    <li class="layui-this"><a href="admin.php?view=audioreply">语音消息</a></li>
                ...
                <table cellspacing="0" cellpadding="0" border="0" class="layui-table">
                        ...
                        <thead>
                            <tr>
                                  ...
                                  <td width="20%" class="hidden-xs">音频</td>
                        ...
                        <tbody>
                                [##section name=loop loop=$datalist##]
                                  <tr [##if $smarty.section.loop.index is even##] class="even"[##/if##]>
                                    ...
                                    <td class="hidden-xs">
                                         [##if $datalist[loop].audiofilepath##]
                                          <script src="./admin/tpl/js/html5media.min.js"></script>
                                          <audio class="audio" controls="" preload="">
                                          <source src="[##$_SC.attachdir##]media/[##$datalist[loop].audiofilepath##]">
                                          <source src="[##$_SC.attachdir##]media/[##$datalist[loop].audiofilepath##]">
                                          </audio>
                                          [##else##]
                                          <img src="[##picredirect($datalist[loop].audiofilepath)##]" width="100" height="80">
                                          [##/if##]
                                    </td>
                                    <td class="hidden-xs">[##$datalist[loop].username##]</td>
                                    <td class="hidden-xs">[##$datalist[loop].dateline|date_format:"%Y-%m-%d %H:%M:%S"##]</td>
                                    <td>
                                      <a href="admin.php?view=audioreply&op=edit&id=[##$datalist[loop].id##]">编辑</a>
                                      &nbsp;<a href="admin.php?view=audioreply&op=del&id=[##$datalist[loop].id##]" onClick="return confirm('本操作不可恢复，确认删除？');">删除</a>
                                    </td>
                                  </tr>
                                  [##sectionelse##]
                                  <tr>
                                   ...
                                   <tr>
                                      <td  colspan="8" align='left'>
                                             <div class="layui-btn-group">
                                               <input type="button" onclick="javascript:window.location.href='admin.php?view=audioreply&op=add'" value="增加" class="layui-btn  layui-btn-sm" >
                                               <input type="button"  onclick="javascript:window.location.href='admin.php?view=audioreply'" value="全部" class="layui-btn  layui-btn-sm">
...
<form method="post" action="admin.php?view=audioreply&op=[##$op##]" enctype="multipart/form-data"  >
    <input type="hidden" name="formhash" value="[##$_SGLOBAL.formhash##]" />
    <input type="hidden" name="refer" value="[##$_SGLOBAL.refer##]" />
    <input type="hidden" name="id" value="[##$result.id##]" />
  <fieldset class="layui-elem-field layui-field-title" >
    <legend>微信语音回复管理</legend>
  </fieldset>
          ...
          <div class="layui-form  layui-form-pane" style="margin:1rem;">
              ...
              <div class="layui-form-item">
               ...
               <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input name="source" value="[##$result.source##]"  class="layui-input" > 
                </div>
              </div>
              ...
              <div class="layui-form-item ">
                ...
                <div class="layui-inline">
                     [##if $result.audiofilepath##]
                        <script src="./admin/tpl/js/html5media.min.js"></script>
                        <audio class="audio" controls="" preload="" style="float: left;">
                        <source src="[##$_SC.attachdir##]media/[##$result.audiofilepath##]">
                        <source src="[##$_SC.attachdir##]media/[##$result.audiofilepath##]">
                        </audio>
                    <a href="admin.php?view=audioreply&op=audiodel&id=[##$result.id##]" style="float: left;margin-left: 10px;">删除</a>
                    [##else##]
                     <a href="javascript:;" class="a-upload">
                      <input type="file" name="audiofilepath" id="poster" />
                      <div class="showFileName">点击上传语音</div>
                    </a>
