          ...
          <input type="hidden" name="formhash" value="[##$_SGLOBAL.formhash##]" />
                ...
                <div class="layui-tab layui-tab-card">
                  <ul  class="layui-tab-title">
                    ...
                    <li ><a href="admin.php?view=picreply">图片消息</a></li>
                    <li ><a href="admin.php?view=audioreply">语音消息</a></li>
                    <li class="layui-this"><a href="admin.php?view=videoreply">视频消息</a></li>
                  </ul>                  
                </div>
                                   ...
                                   <tr>
                                      <td  colspan="8" align='left'>
                                             <div class="layui-btn-group">
                                               <input type="button" onclick="javascript:window.location.href='admin.php?view=videoreply&op=add'" value="增加" class="layui-btn  layui-btn-sm" >
                                               <input type="button"  onclick="javascript:window.location.href='admin.php?view=videoreply'" value="全部" class="layui-btn  layui-btn-sm">
