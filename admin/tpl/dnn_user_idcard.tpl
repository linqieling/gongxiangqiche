        ...
        <form class="layui-form layui-form-pane ">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-block">
                <input type="tel" name="name" lay-verify="required"   value="[##$result.name##]" class="layui-input" >
              </div>
          </div>
          <div class="layui-form-item">
              <label class="layui-form-label">身份证号</label>
              <div class="layui-input-block">
                <input type="tel" name="number" placeholder="" autocomplete="off"  value="[##$result.number##]" class="layui-input" >
              </div>
          </div>
          <div class="layui-form-item">
