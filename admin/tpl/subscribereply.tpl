...
<form method="post" action="admin.php?view=subscribereply&op=[##$op##]" enctype="multipart/form-data">
	<input type="hidden" name="formhash" value="[##$_SGLOBAL.formhash##]" />
	<input type="hidden" name="refer" value="[##$_SGLOBAL.refer##]" />
  <fieldset class="layui-elem-field layui-field-title" >
    <legend>[##if $_SESSION.lang eq 'english'##]Wechat attention reply management [##else##]微信关注回复管理[##/if##]</legend>
  </fieldset>
        <div class="layui-tab-item layui-show">
          <div class="layui-form  layui-form-pane" style="margin:1rem;">
              ...
              <div class="layui-form-item type" [##if $op=='add'##][##elseif $result.type eq 2##]style="display:none;"[##/if##]>
                <label class="layui-form-label">[##if $_SESSION.lang eq 'english'##]Reply type [##else##]回复类型[##/if##]</label>
