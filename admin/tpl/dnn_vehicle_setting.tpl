        ...
        <div class="layui-form layui-form-pane ">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
				   <input type="text" name="vehicleid" id="vehicleid" autocomplete="off" placeholder="车辆管理" class="layui-input readonly" value="[##$vehicleid##]" required lay-verify="required" readonly="readonly" />
				</div>
			</div>
			<div class="layui-form-item">
				<label class="layui-form-label">心跳间隔</label>
				<div class="layui-input-inline">
				   <input type="text" name="sending" autocomplete="off" class="layui-input" placeholder="心跳间隔(秒)" value="[##$result.sending##]" >
				</div>
			...
			<fieldset class="layui-elem-field site-demo-button" style="padding:10px;">
			    ...
			    <div class="layui-form-item">
				    ...
				    <div class="layui-input-inline">
				        <input type="text" name="host" id="host" autocomplete="off" placeholder="主服务器ip地址" class="layui-input" value="[##$result.host##]" />
				    </div>
			    ...
			    <div class="layui-form-item">
				    ...
				    <div class="layui-input-inline">
				        <input type="text" name="backups_host" id="backups_host" autocomplete="off" placeholder="备份服务器ip地址" class="layui-input" value="[##$result.backups_host##]" />
				    </div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
				      <input type="text" name="port" id="port" autocomplete="off" placeholder="请输入服务器端口" class="layui-input" value="[##$result.port##]" />
				</div>
			...
			<fieldset class="layui-elem-field site-demo-button" style="padding:10px;">
			    ...
			    <div class="layui-form-item">
			        <div class="layui-inline">
					  ...
					  <div class="layui-input-inline">
					    <input type="text" name="work_time" autocomplete="off" class="layui-input" placeholder="工作时时间汇报间隔(秒)" value="[##$result.work_time##]" />
					  </div>
					</div>
					<div class="layui-inline">
					  <label class="layui-form-label">距离间隔</label>
					  <div class="layui-input-inline">
					    <input type="text" name="work_distance" autocomplete="off" class="layui-input" placeholder="工作时距离汇报间隔(米)" value="[##$result.work_distance##]" />
					  </div>
					</div>
				</div>
			</fieldset>
            ...
            <fieldset class="layui-elem-field site-demo-button" style="padding:10px;">
			    ...
			    <div class="layui-form-item">
			        <div class="layui-inline">
					  <label class="layui-form-label">时间间隔</label>
					  <div class="layui-input-inline">
					    <input type="text" name="sleep_time" autocomplete="off" class="layui-input" placeholder="休眠时汇报时间间隔(秒)" value="[##$result.sleep_time##]" />
					  </div>
					</div>
					<div class="layui-inline">
					  <label class="layui-form-label">距离间隔</label>
					  <div class="layui-input-inline">
					    <input type="text" name="sleep_distance" autocomplete="off" class="layui-input" placeholder="休眠时汇报距离间隔(米)" value="[##$result.sleep_distance##]" />
					  </div>
					</div>
				</div>
			</fieldset>
			...
			<div class="layui-form-item">
				<label class="layui-form-label">时间间隔</label>
				<div class="layui-input-inline">
				  <input type="text" name="time" autocomplete="off" class="layui-input"  placeholder="订单上报时间间隔(秒)"  value="[##$result.time##]" />
				</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
				   <input type="text" name="mileage" autocomplete="off" class="layui-input"  placeholder="车辆总里程(米)"  value="[##$result.mileage##]" >
				</div>
      	...
      	layui.use(['form', 'jquery','upload'], function() {
        	var form = layui.form,
          	...
          	form.on('submit(formDemo)', function(data) {
          		...
          		var html = '<input type="hidden" id="vehicleid" value="[##$vehicleid##]" />'
