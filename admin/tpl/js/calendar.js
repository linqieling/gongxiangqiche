...
_path = (function( script, i ){
	...
	return path.substr( 0, path.lastIndexOf('/') - 2 );
	...
	'<td>' +
	    '<div class="lcui_head">' +
			...
			'<tr>' +
				...
				'<td width="40" align="center"><input class="cui_im" maxlength="4" value=""/>月</td>' +
				'<td width="14"><a class="cui_nm" href="javascript:void(0);"></a></td>' +
				'<td width="14"><a class="cui_py" href="javascript:void(0);"></a></td>' +
				'<td width="60" align="center"><input class="cui_iy" maxlength="4" value=""/>年</td>' +
...
(function(head){
	...
	link.href = _path + 'css/calendar.css';
    link.rel = 'stylesheet';
