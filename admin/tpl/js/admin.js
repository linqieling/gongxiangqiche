...
$(document).ready(function(){ 
  ...
  $(".a-upload").on("change","input[type='file']",function(){
	...
	if(filePath.indexOf("jpg")!=-1 || filePath.indexOf("jpeg")!=-1 || filePath.indexOf("gif")!=-1|| filePath.indexOf("bmp")!=-1 || filePath.indexOf("png")!=-1){
        $(".fileerrorTip").html("").hide();
        var arr=filePath.split('\\');
        var fileName=arr[arr.length-1];
        $(this).parent().find("div.showFileName").html(fileName);
    }else{
		$(this).parent().find("div.showFileName").html("点击这里选择文件");
