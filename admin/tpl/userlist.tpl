            ...
            <input type="hidden" name="view" value="userlist">
              ...
              <div class="layui-form-item">
                <div class="layui-inline">
                    <input type="text" name="sphone"  class="layui-input" placeholder="[##if $_SESSION.lang eq 'english'##]Please input mobile phone number[##else##]请输入手机号[##/if##]" value="[##$search.sphone##]" autocomplete="off" />
                </div>
                <div class="layui-inline">
                     <input type="text" name="susername" value="[##$search.susername##]"  class="layui-input"  autocomplete="off" placeholder="[##if $_SESSION.lang eq 'english'##]Please enter user name[##else##]请输入用户姓名[##/if##]" />
                </div>

                <div class="layui-inline">
                    <select name='idcard'>
                        <option  value="">[##if $_SESSION.lang eq 'english'##]Real name verification[##else##]实名验证[##/if##]</option>
                        <option  value="3" [##if $search.idcard eq 3 ##] selected="select"[##/if##]>[##if $_SESSION.lang eq 'english'##]Failed[##else##]未通过[##/if##]</option>
                        <option  value="4" [##if $search.idcard eq 4 ##] selected="select"[##/if##]>[##if $_SESSION.lang eq 'english'##]Not submitted[##else##]未提交[##/if##]</option>
                        <option  value="1" [##if $search.idcard eq 1 ##] selected="select"[##/if##]>[##if $_SESSION.lang eq 'english'##]To be reviewed[##else##]待审核[##/if##]</option>
                        <option  value="2" [##if $search.idcard eq 2 ##] selected="select"[##/if##]>[##if $_SESSION.lang eq 'english'##]Real name[##else##]已实名[##/if##]</option>
                    </select>
                </div>
                <div class="layui-inline">
                    <select name='drive'>
                        <option  value="">[##if $_SESSION.lang eq 'english'##]Driver's license certification[##else##]驾驶证认证[##/if##]</option>
                        <option  value="3" [##if $search.drive eq 3 ##] selected="select"[##/if##]>[##if $_SESSION.lang eq 'english'##]Failed[##else##]未通过[##/if##]</option>
                        <option  value="4" [##if $search.drive eq 4 ##] selected="select"[##/if##]>[##if $_SESSION.lang eq 'english'##]Not submitted[##else##]未提交[##/if##]</option>
                        <option  value="1" [##if $search.drive eq 1 ##] selected="select"[##/if##]>[##if $_SESSION.lang eq 'english'##]To be reviewed[##else##]待审核[##/if##]</option>
                        <option  value="2" [##if $search.drive eq 2 ##] selected="select"[##/if##]>[##if $_SESSION.lang eq 'english'##]Certified[##else##]已认证[##/if##]</option>
                    </select>
                </div>
                <div class="layui-inline">
                    <select name='status'>
                        <option value="">[##if $_SESSION.lang eq 'english'##]status[##else##]状态[##/if##]</option>
                        <option value="1" [##if $search.status eq 1##] selected="select"[##/if##]>[##if $_SESSION.lang eq 'english'##]Deposit paid[##else##]已交押金[##/if##]</option>
                        <option value="0" [##if $search.status === '0'##] selected="select"[##/if##]>[##if $_SESSION.lang eq 'english'##]Locked[##else##]已锁定[##/if##]</option>
                    </select>
                </div>

                <div class="layui-inline">
                    <input type="text" name="srcode" value="[##$search.srcode##]"  class="layui-input"  autocomplete="off" placeholder=">[##if $_SESSION.lang eq 'english'##]Please enter the recommended code[##else##]请输入推荐编码[##/if##]" />
                </div>

                <div class="layui-inline">
                    <input name="searchsubmit" type="submit" class="submit layui-btn"  value="[##if $_SESSION.lang eq 'english'##]Submit immediately[##else##]立即提交[##/if##]">
                </div>
              </div>
                    ...
                    <table cellspacing="0" cellpadding="0" border="0" class="layui-table">
                            ...
                            <thead>
                                ...
                                <tr>
                                  ...
                                  <td align="center" width="6%" class="hidden-xs">[##if $_SESSION.lang eq 'english'##]head portrait[##else##]头像[##/if##]</td>
                                  <td width="12%" class="hidden-xs">[##if $_SESSION.lang eq 'english'##]phone number[##else##]手机号码[##/if##]</td>
                                  <td width="12%">[##if $_SESSION.lang eq 'english'##]User name[##else##]用户姓名[##/if##]</td>
                                  <td align="center" width="12%">[##if $_SESSION.lang eq 'english'##]ID card| Driving license[##else##]身份证|驾驶证[##/if##]</td>
                                  <td align="center" width="5%" class="hidden-xs">[##if $_SESSION.lang eq 'english'##]balance[##else##]余额[##/if##]</td>
                                  <td align="center" width="5%" class="hidden-xs">[##if $_SESSION.lang eq 'english'##]deposit[##else##]押金[##/if##]</td>
                                  <td align="center" width="5%" class="hidden-xs">[##if $_SESSION.lang eq 'english'##]status[##else##]状态[##/if##]</td>
                                  <td align="center" width="5%" class="hidden-xs">[##if $_SESSION.lang eq 'english'##]Recommendation code[##else##]推荐码[##/if##]</td>
                            ...
                            <tbody>
                                 [##section name=loop loop=$datalist##]
                                    <tr [##if $smarty.section.loop.index is even##] class="even"[##/if##]>
                                      ...
                                      <td align="center">
                                        <div class="layui-btn-group">
                                          [##if $datalist[loop].idstatus==-1##]
                                            <a  class="layui-btn layui-btn-xs layui-btn-danger">[##if $_SESSION.lang eq 'english'##]Failed[##else##]未通过[##/if##]</a>
                                          [##else if $datalist[loop].idstatus==0 ##]
                                            <a  class="layui-btn layui-btn-xs layui-btn-disabled">[##if $_SESSION.lang eq 'english'##]Not submitted[##else##]未提交[##/if##]</a>
                                          [##else if $datalist[loop].idstatus==1 ##]
                                            <a  class="layui-btn layui-btn-xs layui-btn-normal">[##if $_SESSION.lang eq 'english'##]To be reviewed[##else##]待审核[##/if##]</a>
                                          [##else if $datalist[loop].idstatus==2 ##]
                                            <a  class="layui-btn layui-btn-xs">[##if $_SESSION.lang eq 'english'##]Real name[##else##]已实名[##/if##]</a>
                                          [##/if##]
                                          ...
                                          [##else if $datalist[loop].drstatus==2 ##]
                                            <a  class="layui-btn layui-btn-xs">[##if $_SESSION.lang eq 'english'##]Certified[##else##]已认证[##/if##]</a>
                                          [##/if##]
                                        </div>
                                      </td>
                                      ...
                                      <td align="center" class="hidden-xs">
                                      	<div class="layui-btn-group">
                                             ...
                                             <a class="layui-btn layui-btn-xs layui-btn-danger">[##if $_SESSION.lang eq 'english'##]locking[##else##]锁定[##/if##]</a>
	                                        [##elseif $datalist[loop].deposit==$_SCONFIG.deposit##]
                                      		   <a class="layui-btn layui-btn-xs">[##if $_SESSION.lang eq 'english'##]Rentable car[##else##]可租车[##/if##]</a>
	                                        [##elseif $datalist[loop].drstatus==2 ##]
	                                           <a class="layui-btn layui-btn-xs">[##if $_SESSION.lang eq 'english'##]Certified[##else##]已认证[##/if##]</a>
	                                        [##elseif $datalist[loop].drstatus==2 ##]
	                                           <a class="layui-btn layui-btn-xs">[##if $_SESSION.lang eq 'english'##]Real name[##else##]已实名[##/if##]</a>
	                                        [##elseif $datalist[loop].phone##]
	                                           <a class="layui-btn layui-btn-xs">[##if $_SESSION.lang eq 'english'##]Registered[##else##]已注册[##/if##]</a>
	                                        [##/if##]
                                      	</div>
                                      </td>
                                      <td align="center" class="hidden-xs">[##$datalist[loop].rcode##]</td>
                                      <td>
                                        <a class="layui-btn layui-btn-xs layui-btn-normal" href="admin.php?view=userlist&op=edit&uid=[##$datalist[loop].uuid##]" lay-event="edit">[##if $_SESSION.lang eq 'english'##]View details[##else##]查看详情[##/if##]</a>
                                    ...
                                    [##sectionelse##]
                                    <tr>
                                      <td colspan="11" align="center"[##if $_SESSION.lang eq 'english'##]There is no data at present[##else##]当前暂无任何数据[##/if##]>!</td>
                                    </tr>
                                    [##/section##]
                                    [##if $multi##]
                                    <tr>
        ...
        $('#count').click(function() {
              ...
              var html=`<div class="site-banner_s">
                        <a rel="nofollow"  class="site-star">
                          ...
                          [##if $_SESSION.lang eq 'english'##]Total number of customers[##else##]客户总数[##/if##]：<cite id="getStars">${res.result.total}[##if $_SESSION.lang eq 'english'##]People[##else##]人[##/if##]</cite>
                        </a>
                        <a  rel="nofollow" class="site-star">
                          <i class="layui-icon"></i>
                          [##if $_SESSION.lang eq 'english'##]Registered number[##else##]已注册数[##/if##]：<cite id="getStars">${res.result.register}[##if $_SESSION.lang eq 'english'##]People[##else##]人[##/if##]</cite>
                        </a>
                        <a  rel="nofollow" class="site-fork">
                          <i class="layui-icon"></i>
                          [##if $_SESSION.lang eq 'english'##]Number of real names[##else##]已实名数[##/if##]：<cite id="getStars">${res.result.real}[##if $_SESSION.lang eq 'english'##]People[##else##]人[##/if##]</cite>
                        </a>
                        <a  rel="nofollow" class="site-fork">
                          <i class="layui-icon"></i>
                          [##if $_SESSION.lang eq 'english'##]Number of rental cars[##else##]可租车数[##/if##]：<cite id="getStars">${res.result.rented}[##if $_SESSION.lang eq 'english'##]People[##else##]人[##/if##]</cite>
                        </a>
                      </div>`;
		        	//页面层
    					layer.open({
                ...
                <table cellspacing="0" cellpadding="0" border="0" class="layui-table">
                        ...
                        <thead>
                            <tr>
                                  ...
                                  <td width="10%">[##if $_SESSION.lang eq 'english'##]integral[##else##]积分[##/if##]</td>
                                  <td width="10%" class="hidden-xs">[##if $_SESSION.lang eq 'english'##]operation people[##else##]操作人[##/if##]</td>
                                  <td width="10%" class="hidden-xs">[##if $_SESSION.lang eq 'english'##]Recording time[##else##]记录时间[##/if##]</td>
                        ...
                        <tbody>
                          ...
                          <tr [##if $smarty.section.loop.index is even##] class="even"[##/if##]>
                            ...
                            <td>
                              <a href="admin.php?view=userlist&op=delcredits&id=[##$datalist[loop].id##]">[##if $_SESSION.lang eq 'english'##]Delete record[##else##]删除记录[##/if##]</a>
                            </td>
                          </tr>
                          [##sectionelse##]
                          <tr>
                          ...
                          <tr>
                            <td  colspan="7" align="left">
                              <div class="layui-btn-group">
                                ...
                                <input type="button" onClick="javascript:window.location.href='admin.php?view=userlist'" value="[##if $_SESSION.lang eq 'english'##]Return to previous page[##else##]返回上一页[##/if##]" class="submit layui-btn  layui-btn-sm " />
...
[##else##]
    <fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
      <legend>会员资料
        [##if $result.olduser==1 ##]
            <span class="layui-badge">[##if $_SESSION.lang eq 'english'##]old user[##else##]老用户[##/if##]</span>
        [##else##]
            <span class="layui-badge layui-bg-green">[##if $_SESSION.lang eq 'english'##]new user[##else##]新用户[##/if##]</span>
        [##/if##]
      </legend>
    </fieldset>
    <style type="text/css">
    ...
    <form method="post" action="admin.php?view=userlist&op=[##$op##]" enctype="multipart/form-data"  >
      <div class="layui-form  layui-form-pane" style="padding:0.5rem;">
        ...
        <div class="layui-form-item ">
          <label class="layui-form-label">[##if $_SESSION.lang eq 'english'##]Recommended salesman[##else##]推荐业务员[##/if##]</label>
        ...
        <div class="layui-form-item ">
          <label class="layui-form-label">[##if $_SESSION.lang eq 'english'##]References[##else##]推荐人[##/if##]</label>
          <div class="layui-input-inline">
            <input  class="layui-input readonly" type="text" size="30" value="[##$ruser##]" readonly="readonly" />
          </div>
          <div class="layui-btn" id="ruserinfo">[##if $_SESSION.lang eq 'english'##]see information[##else##]查看信息[##/if##]</div>
        </div>
        [##/if##]

        <div class="layui-form-item ">
          <label class="layui-form-label">[##if $_SESSION.lang eq 'english'##]balance[##else##]余额[##/if##]</label>
          <div class="layui-input-inline">
          ...
          <div class="layui-btn " id="balance">[##if $_SESSION.lang eq 'english'##]Recharge details[##else##]充值明细[##/if##]</div>
        </div>
        <div class="layui-form-item ">
          <label class="layui-form-label">[##if $_SESSION.lang eq 'english'##]deposit[##else##]押金[##/if##]</label>
          <div class="layui-input-inline">
          ...
          [##/if##] -->
          <div class="layui-btn " id="deposit">[##if $_SESSION.lang eq 'english'##]Deposit details[##else##]押金明细[##/if##]</div>
        </div>
        <!-- <div class="layui-form-item ">
        ...
        <div class="layui-form-item">
          <div class="layui-inline">
            <label class="layui-form-label">[##if $_SESSION.lang eq 'english'##]Identity card authentication[##else##]身份证认证[##/if##]</label>
            <div class="layui-input-inline">
              <div class="layui-btn"  id="idcard" >
                  [##if $result.idstatus==-1##]
                  [##if $_SESSION.lang eq 'english'##]Failed[##else##]未通过[##/if##]
                  [##else if $result.idstatus==0 ##]
                  [##if $_SESSION.lang eq 'english'##]Not submitted[##else##]未提交[##/if##]
                  [##else if $result.idstatus==1 ##]
                  [##if $_SESSION.lang eq 'english'##]To be reviewed[##else##]待审核[##/if##]
                  [##else if $result.idstatus==2 ##]
                  [##if $_SESSION.lang eq 'english'##]Reviewed[##else##]已审核[##/if##]
                  [##/if##]
              </div>
            </div>
          </div>
          <div class="layui-inline">
            <label class="layui-form-label">[##if $_SESSION.lang eq 'english'##]Driver's license certification[##else##]驾驶证认证[##/if##]</label>
            <div class="layui-input-inline">
        ...
        <div class="layui-form-item ">
          ...
          <div class="layui-input-block">
              <input type="radio" name="status" value="0" title="[##if $_SESSION.lang eq 'english'##]locking[##else##]锁定[##/if##]" [##if $result.status eq 0##] checked="" [##/if##]>
              <input type="radio" name="status" value="1" title="[##if $_SESSION.lang eq 'english'##]normal[##else##]正常[##/if##]" [##if $result.status eq 1##] checked="" [##/if##]>
          </div>
        </div>

        <div class="layui-form-item">
          <div class="layui-inline">
            <label class="layui-form-label">[##if $_SESSION.lang eq 'english'##]send message[##else##]发送消息[##/if##]</label>
            <div class="layui-input-inline">
              <div class="layui-btn" id="sendMsg">[##if $_SESSION.lang eq 'english'##]Click send[##else##]点击发送[##/if##]</div>
            </div>
          </div>
        </div>
        ...
        <blockquote class="layui-elem-quote">
            [##if $_SESSION.lang eq 'english'##]personal data[##else##]个人资料[##/if##]
        </blockquote>

        <div class="layui-form-item layui-form-text ">
          <label class="layui-form-label">[##if $_SESSION.lang eq 'english'##]user head portrait[##else##]用户头像[##/if##]</label>
          <div class="layui-input-block ">
               <img style="float: left;cursor:pointer;" src="[##picredirect($result.avatar,1)##]" class="changeavatar" width="80" height="80" title="[##if $_SESSION.lang eq 'english'##]Click avatar to modify[##else##]点击头像修改[##/if##]" />
                <div class="layui-form-mid layui-word-aux" style="line-height:70px;">[##if $_SESSION.lang eq 'english'##]Click avatar to modify[##else##]点击头像修改[##/if##]</div>
          </div>
        </div>
        ...
        <div class="layui-form-item ">
          ...
          <div class="layui-input-block">
              <select name="sex">
                 <option value='0' [##if $result.sex eq 0##] selected=selected [##/if##][##if $_SESSION.lang eq 'english'##]secrecy[##else##]保密[##/if##]></option>
                 <option value='1' [##if $result.sex eq 1##] selected=selected [##/if##]>[##if $_SESSION.lang eq 'english'##]man[##else##]帅哥[##/if##]</option>
                 <option value='2' [##if $result.sex eq 2##] selected=selected [##/if##]>[##if $_SESSION.lang eq 'english'##]woman[##else##]美女[##/if##]</option>
              </select>
        ...
        <div class="layui-form-item ">
             <label class="layui-form-label">[##if $_SESSION.lang eq 'english'##]Location[##else##]所在地[##/if##]</label>
             <div class="layui-input-block">
         ...
         <div class="layui-form-item ">
             <label class="layui-form-label">[##if $_SESSION.lang eq 'english'##]Registration time[##else##]注册时间[##/if##]</label>
             <div class="layui-input-block">
        ...
        <div class="layui-form-item" style="margin-top: 30px; padding-bottom: 50px;">
          <div class="layui-input-block">
            <input name="submit" type="submit" class="submit layui-btn layui-btn-normal" value="[##if $_SESSION.lang eq 'english'##]preservation[##else##]保存[##/if##]" />
            <input type="button" onclick="javascript:window.location.href='[##$_SGLOBAL.refer##]'" class="submit layui-btn layui-btn-normal" value="[##if $_SESSION.lang eq 'english'##]Back to list[##else##]返回列表[##/if##]" />
          </div>
        </div>
        [##/if##]
        ...
        var form = layui.form;
         ...
         form.render;
          ...
          $("#balance").click(function(){
                ...
                var iframeObj = $(window.frameElement).attr('name');
                parent.page("[##if $_SESSION.lang eq 'english'##]Recharge details[##else##]充值明细[##/if##]", url, iframeObj, w = "700px", h = "620px");
                return false;
          });
          ...
          $('#sendMsg').click(function(){
            ...
            var iframeObj = $(window.frameElement).attr('name');
            parent.page("[##if $_SESSION.lang eq 'english'##]send message[##else##]发送消息[##/if##]", url, iframeObj, w = "700px", h = "620px");
            return false;
          });
