      ...
      <div class="box3" style="width:960px;">
        ...
        <div class="boxcontent">
            ...
            [##section name=loop loop=$data##]
              <li>
                 <a href="[##$_SCONFIG.webroot##]index-downshow-id-[##$data[loop].id##]-catid-[##$data[loop].catid##].html" target="_self">[##$data[loop].name##]</a><span>[##$data[loop].dateline|date_format:"%Y-%m-%d"##]</span>
              </li>
            [##sectionelse##]
