          ...
          <div class="boxcontent">
            <div style="width:100%; margin:auto auto auto 10px; overflow:hidden;">
              ...
              <div style="padding:10px 13px; width:160px; overflow:hidden; float:left;">
                ...
                <img src="[##picredirect($data[loop].picfilepath)##]" style="height:158px; width:158px; display:block; border: 1px #CCCCCC dashed;" >
                </a>
                <div style="width:160px; height:30px; line-height:30px; overflow:hidden; color:#747474; text-align:center;">[##$data[loop].name##]</div>
              </div>
              [##sectionelse##]
