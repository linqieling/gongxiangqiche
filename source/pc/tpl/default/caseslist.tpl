          ...
          <div class="boxcontent">
            <div style="width:100%; margin:auto auto auto 10px; overflow:hidden;">
              ...
              <div style="padding:10px 13px; width:160px; overflow:hidden; float:left;">
                <a href="[##$_SCONFIG.webroot##]index-casesshow-id-[##$data[loop].id##]-catid-[##$data[loop].catid##].html" target="_self">
                ...
                <div style="width:160px; height:30px; line-height:30px; overflow:hidden; color:#747474; text-align:center;">
                  <a [##if $data[loop].titlecolor##]style="color:[##$data[loop].titlecolor##]"[##/if##] href="[##$_SCONFIG.webroot##]index-casesshow-id-[##$data[loop].id##]-catid-[##$data[loop].catid##].html" target="_self">
                  [##$data[loop].name##]</a>
                </div>
              </div>
              [##sectionelse##]
