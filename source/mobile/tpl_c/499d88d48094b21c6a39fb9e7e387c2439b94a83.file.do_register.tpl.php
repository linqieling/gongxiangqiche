<?php /* Smarty version Smarty-3.1.13, created on 2019-01-16 21:33:37
         compiled from "E:\www\dianniuniu\source\mobile\tpl\default\do_register.tpl" */ ?>
<?php /*%%SmartyHeaderCode:285225c3f32b1404979-15848527%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '499d88d48094b21c6a39fb9e7e387c2439b94a83' => 
    array (
      0 => 'E:\\www\\dianniuniu\\source\\mobile\\tpl\\default\\do_register.tpl',
      1 => 1547278824,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '285225c3f32b1404979-15848527',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5c3f32b147ea93_45539683',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5c3f32b147ea93_45539683')) {function content_5c3f32b147ea93_45539683($_smarty_tpl) {?><!DOCTYPE HTML>
<html lang="en-US">
<head>
...
do-login.html" style="margin-top:0.2rem;">立即登录</a>
        </div>
	</main>
...
do-register-op-regsubmit.html",    // 提交到controller的url路径
                    type: "post",    // 提交方式
                    data: {"phone": username, "code": code, "refer": $('#refer').val()},  // data为String类型，必须为 Key/Value 格式。
                    dataType: "json",       // 服务器端返回的数据类型
                    success: function (res) {    
                    // 请求成功后的回调函数，其中的参数data为controller返回的map,也就是说,@ResponseBody将返回的map
                        $('#loadbg').hide();
