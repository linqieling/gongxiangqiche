<?php /* Smarty version Smarty-3.1.13, created on 2019-01-16 20:47:42
         compiled from "E:\www\dnn\source\mobile\tpl\default\cp_orderdetails.tpl" */ ?>
<?php /*%%SmartyHeaderCode:157945c3d74ecb39ea5-80002482%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '598d1358b683fc76fd91b586e527b8e7a96095fd' => 
    array (
      0 => 'E:\\www\\dnn\\source\\mobile\\tpl\\default\\cp_orderdetails.tpl',
      1 => 1547642706,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '157945c3d74ecb39ea5-80002482',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_5c3d74ecd22322_28002770',
  'variables' => 
  array (
    'vehicle' => 0,
    '_SPATH' => 0,
...
<?php if ($_valid && !is_callable('content_5c3d74ecd22322_28002770')) {function content_5c3d74ecd22322_28002770($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'E:\\www\\dnn\\framework\\include\\SmtClass\\plugins\\modifier.date_format.php';
                ...
                <div class="bui-btn bui-box">
                    ...
                    <div class="span1">
                        ...
                        <p class="item-text">
                          ...
                          <span class="bui-value"><info><?php echo $_smarty_tpl->tpl_vars['details']->value['pwd'];?>
</info></span>
                        </p>
                    </div>
                    <?php }?>
...
" />
                        ...
                        <p class="item-text">
                           ...
                           <span class="bui-value">
                            <info class='mileage'><?php if ($_smarty_tpl->tpl_vars['details']->value['status']==1||$_smarty_tpl->tpl_vars['details']->value['status']==2){?><?php echo sprintf("%.2f",$_smarty_tpl->tpl_vars['vehicle']->value['totalmileage']-$_smarty_tpl->tpl_vars['details']->value['totalmileage']);?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['details']->value['mileage'];?>
<?php }?></info>&nbsp;公里
                           </span>
                           <input type="hidden" id="mileage" value="<?php echo $_smarty_tpl->tpl_vars['details']->value['mileage'];?>
"/>
...
"/>
                    ...
                    <span class="price" id="totalmoney_show" style="color: red;font-size: 0.4rem;">
                      ...
                      <p style="margin: 0 !important;padding:0 !important;font-size: 0.26rem;text-align: center;text-decoration:line-through;">(<i>￥</i><?php echo $_smarty_tpl->tpl_vars['details']->value['totalmoney'];?>
)</p>
                      <?php }else{ ?>
                ...
                <div class="span1">
                  ...
                  <p class="item-text">
                    ...
                    <span class="bui-value">
                      ...
                      <?php }elseif($_smarty_tpl->tpl_vars['details']->value['paytype']==3){?>支付宝支付
                      <?php }else{ ?>其它支付
                      <?php }?>
                    </span>
                  </p>
...
.html" style="color: #FEFEFE;">立即支付</a>
              ...
              <ul class="bui-group mini btn_box">
                <li id="open_btn" class="bui-btn"><i class="icon-unlock"></i>解锁</li>
                <li id="close_btn" class="bui-btn"><i class="icon-lock"></i>锁车</li>
 ...
 元</div>
          ...
          <?php if ($_smarty_tpl->tpl_vars['details']->value['couponid']){?>
          <div class="bui-btn bui-box">
            <div class="bui-label">优惠金额</div>
            <div class="span1">
              <div class="bui-value"><?php echo sprintf("%.2f",$_smarty_tpl->tpl_vars['details']->value['totalmoney']-$_smarty_tpl->tpl_vars['details']->value['finalmoney']);?>
 元</div>
            </div>
          </div>
          <?php }?>
        ...
        bui.ready(function(){
          ...
          <?php if ($_smarty_tpl->tpl_vars['details']->value['status']==1){?>
            bui.confirm({
              "title": "",
              "height": 460,
              "content":'<div class="bui-box-center"><i class="icon-successfill success"></i>无任何操作将在<?php echo $_smarty_tpl->tpl_vars['_SCONFIG']->value['countdown'];?>
分钟后开始计费</div>',
          ...
          var vehicle_status,quantity_status;
          ...
          //建立WebSocket通讯
          socket = new WebSocket('ws://119.29.186.195:19766');
...
.html"
                      ...
                      $('#loadbg').show();
                      //--------------------------开车门--------
                      var send_data = '{"type":"door", "status":"1"}';
                      socket.send( send_data );
                      //--------------------------开车门--------
                    }else{
                      bui.alert(res.msg);
...
.html"
                    ...
                    Loading_box.show();
                    $('#loadbg').show();
                    var send_data = '{"type":"door", "status":"2"}';
                    socket.send( send_data );
                  }else{
                    bui.alert(res.msg);
                  }
...
.html",
            ...
            setInterval(function () {
              ...
              }else if(mileage > parseFloat(<?php echo $_smarty_tpl->tpl_vars['_SCONFIG']->value['maxmileage'];?>
)){//超过最高里程
