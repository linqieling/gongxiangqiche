<?php /* Smarty version Smarty-3.1.13, created on 2019-05-27 09:12:52
         compiled from "E:\www\dianniuniu\source\mobile\tpl\default\cp_orderdetails.tpl" */ ?>
<?php /*%%SmartyHeaderCode:178925c4054220cae25-77265827%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7b03dae0738c5627609570f75d3f43539bd6bf8f' => 
    array (
      0 => 'E:\\www\\dianniuniu\\source\\mobile\\tpl\\default\\cp_orderdetails.tpl',
      1 => 1558919523,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '178925c4054220cae25-77265827',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_5c4054222b32b8_66808305',
  'variables' => 
  array (
    'vehicle' => 0,
    '_SPATH' => 0,
...
<?php if ($_valid && !is_callable('content_5c4054222b32b8_66808305')) {function content_5c4054222b32b8_66808305($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'E:\\www\\dianniuniu\\framework\\include\\SmtClass\\plugins\\modifier.date_format.php';
                    ...
                    <span class="price" id="totalmoney_show" style="color: red;font-size: 0.4rem;">
                      ...
                      <?php }else{ ?>
                        <?php if ($_smarty_tpl->tpl_vars['details']->value['discountmoney']>0){?>
                          ...
                          <?php if (floatval($_smarty_tpl->tpl_vars['_SCONFIG']->value['discount'])>0){?><div style="text-align: center;line-height: 0;"><p style="display: inline-block; margin: 0 !important; padding: 0 0.1rem; font-size: 0.22rem; background: #FF5722; color: #FFF; line-height: 1.5; border-radius: 0.04rem;">已享<b><?php echo $_smarty_tpl->tpl_vars['_SCONFIG']->value['discount'];?>
</b>折</p></div><?php }?>
                        <?php }else{ ?>
...
.html" style="color: #FEFEFE;">立即支付</a>
 ...
 元</div>
          ...
          <?php }?>
          <?php if ($_smarty_tpl->tpl_vars['details']->value['totalmoney']!==$_smarty_tpl->tpl_vars['details']->value['finalmoney']||$_smarty_tpl->tpl_vars['details']->value['couponid']){?>
          <div class="bui-btn bui-box">
