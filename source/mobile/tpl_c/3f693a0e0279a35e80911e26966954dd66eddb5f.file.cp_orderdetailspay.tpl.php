<?php /* Smarty version Smarty-3.1.13, created on 2019-01-15 18:53:07
         compiled from "E:\www\dnn\source\mobile\tpl\default\cp_orderdetailspay.tpl" */ ?>
<?php /*%%SmartyHeaderCode:134305c3d9040471076-04520069%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3f693a0e0279a35e80911e26966954dd66eddb5f' => 
    array (
      0 => 'E:\\www\\dnn\\source\\mobile\\tpl\\default\\cp_orderdetailspay.tpl',
      1 => 1547549569,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '134305c3d9040471076-04520069',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_5c3d90405a2341_89455317',
  'variables' => 
  array (
    '_SPATH' => 0,
    'result' => 0,
...
<?php if ($_valid && !is_callable('content_5c3d90405a2341_89455317')) {function content_5c3d90405a2341_89455317($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ('head.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
            ...
            <div class="bui-panel charging_box"> 
                ...
                <div class="span1">支付金额</div>
                    <div class="span1" style="text-align:right">
                        <info id="totalmoneyshow"><?php echo $_smarty_tpl->tpl_vars['result']->value['totalmoney'];?>
</info>元&nbsp;
                        <input type="hidden" name="totalmoney" id="totalmoney" value="<?php echo $_smarty_tpl->tpl_vars['result']->value['totalmoney'];?>
">
                    </div>
                    <!--最后支付金额-->
...
</info>元 (<?php echo $_smarty_tpl->tpl_vars['_SCONFIG']->value['startmileage'];?>
公里+<?php echo $_smarty_tpl->tpl_vars['_SCONFIG']->value['starttime'];?>
分钟)</span>
                        </p>
                        <p class="item-text">
                            ...
                            <span class="bui-value">
                                ...
                                <?php if ($_smarty_tpl->tpl_vars['result']->value['mileage']<$_smarty_tpl->tpl_vars['_SCONFIG']->value['startmileage']){?>(<?php echo $_smarty_tpl->tpl_vars['_SCONFIG']->value['startmileage'];?>
公里内不计)
                                <?php }elseif($_smarty_tpl->tpl_vars['result']->value['mileage']>$_smarty_tpl->tpl_vars['_SCONFIG']->value['maxmileage']){?>(<?php echo $_smarty_tpl->tpl_vars['_SCONFIG']->value['maxmileage']-$_smarty_tpl->tpl_vars['_SCONFIG']->value['startmileage'];?>
公里×<?php echo $_smarty_tpl->tpl_vars['_SCONFIG']->value['mileagemoney'];?>
元+<?php echo $_smarty_tpl->tpl_vars['result']->value['mileage']-$_smarty_tpl->tpl_vars['_SCONFIG']->value['maxmileage'];?>
公里×<?php echo $_smarty_tpl->tpl_vars['_SCONFIG']->value['maxmileagemoney'];?>
元)
                                <?php }else{ ?>(<?php echo $_smarty_tpl->tpl_vars['result']->value['mileage']-$_smarty_tpl->tpl_vars['_SCONFIG']->value['startmileage'];?>
公里×<?php echo $_smarty_tpl->tpl_vars['_SCONFIG']->value['mileagemoney'];?>
元)
                                <?php }?>
                            </span>
                        ...
                        <p class="item-text">
                            ...
                            <span class="bui-value">
                                ...
                                (<?php if ($_smarty_tpl->tpl_vars['result']->value['duration']-$_smarty_tpl->tpl_vars['_SCONFIG']->value['starttime']>0){?><?php echo $_smarty_tpl->tpl_vars['result']->value['duration']-$_smarty_tpl->tpl_vars['_SCONFIG']->value['starttime'];?>
分钟×<?php echo $_smarty_tpl->tpl_vars['_SCONFIG']->value['minutemoney'];?>
元<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['_SCONFIG']->value['starttime'];?>
分钟内不计<?php }?>)
                            </span>
                        </p>
                        <p class="item-text">
                        ...
                        <p class="item-text">
                            ...
                            <span class="bui-value" id='couponshow'><info>0.00</info>元</span>
                        </p>
                    </div>
...
元</div>
                <div class="bui-value wallet <?php if ($_smarty_tpl->tpl_vars['result']->value['umoney']<=0){?>disabled<?php }?>">
...
cp-orderdetailspay-op-coupon_list.html",
                ...
                data: {
                  'random': Math.random(),
                  'money': '<?php echo $_smarty_tpl->tpl_vars['result']->value['totalmoney'];?>
',
                  'page': page,
                  'pagesize': pagesize
                }
...
cp-userpurse-op-coupon_content.html",
                    ...
                    if(result.status == 4){
                        ...
                        var totalmoney=parseFloat(<?php echo $_smarty_tpl->tpl_vars['result']->value['totalmoney'];?>
);//订单总额
                        ...
                        if(result.type==3){
                            ...
                            if(result.sum > 0){//最高优惠金额
                                if(totalmoney*(result.money/10) >= result.sum){
                                    totalmoneyshow=testMoney(totalmoney-result.sum);
                                    couponshow='<info>'+result.sum+'</info>元&nbsp;(最高优惠金额)';
                                }else{
                                    totalmoneyshow=testMoney(totalmoney-totalmoney*(result.money/10));
                                    couponshow='<info>'+testMoney(totalmoney*(result.money/10))+'</info>元';
                                }
                            }else{
                                totalmoneyshow=testMoney(totalmoney-totalmoney*(result.money/10));
                                couponshow='<info>'+testMoney(totalmoney*(result.money/10))+'</info>元';
                            ...
                            totalmoneyshow=testMoney(totalmoney-result.money);
                            couponshow='<info>'+testMoney(result.money)+'</info>元';
                        }
                        
                        $('#coupon').val(id);//优惠券ID
                        $('#couponmoney').html(couponmoney);
                        $('#totalmoney').val(totalmoneyshow);//支付金额
...
cp-userpurse-op-coupon_overdue.html",
        ...
        $('#nousebtn').on('click', function(){
            $('#coupon').val('');//清除优惠券ID
            $('#couponmoney').html('');
            $('#totalmoney').val('<?php echo $_smarty_tpl->tpl_vars['result']->value['totalmoney'];?>
');//支付金额
            $('#totalmoneyshow').html('<?php echo $_smarty_tpl->tpl_vars['result']->value['totalmoney'];?>
');
            $('#couponshow').html('<info>0.00</info>元');
            CouponBox.close();
        });
...
',
                ...
                if(res.error == 0){
                    if(paytype==1){
                        var result = bui.hint({
                            content: "<i class='icon-check'></i><br />支付成功",
                            position: "center", 
                            effect: "fadeInDown"
                        });
                        setTimeout(function() {
