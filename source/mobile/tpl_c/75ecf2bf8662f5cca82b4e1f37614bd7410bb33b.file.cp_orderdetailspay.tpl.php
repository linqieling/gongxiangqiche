<?php /* Smarty version Smarty-3.1.13, created on 2020-12-15 12:15:42
         compiled from "/huidin/web/share_huidin/source/mobile/tpl/default/cp_orderdetailspay.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18332324455fd8386e2dcda1-92931048%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '75ecf2bf8662f5cca82b4e1f37614bd7410bb33b' => 
    array (
      0 => '/huidin/web/share_huidin/source/mobile/tpl/default/cp_orderdetailspay.tpl',
      1 => 1600675298,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18332324455fd8386e2dcda1-92931048',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5fd8386e3bb1c5_46311044',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fd8386e3bb1c5_46311044')) {function content_5fd8386e3bb1c5_46311044($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ('head.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
分钟内不计费<?php }?>)
                        ...
                        <p class="item-text">
                            ...
                            <?php if ($_smarty_tpl->tpl_vars['kilometre']->value&&$_smarty_tpl->tpl_vars['occupy']->value){?>(每小时低于<?php echo $_smarty_tpl->tpl_vars['kilometre']->value;?>
...
元/分钟)<?php }?>
                        ...
                        <?php if (floatval($_smarty_tpl->tpl_vars['_SCONFIG']->value['discount'])>0&&floatval($_smarty_tpl->tpl_vars['_SCONFIG']->value['discount'])<100&&$_smarty_tpl->tpl_vars['result']->value['discountmoney']>0){?>
                        <p class="item-text">
                            <span class="bui-label">折后金额</span>
                            <span class="bui-value"><info><?php echo $_smarty_tpl->tpl_vars['result']->value['discountmoney'];?>
</info>元
                            (<?php echo floatval($_smarty_tpl->tpl_vars['_SCONFIG']->value['discount']);?>
折)
                            </span>
                        </p>
                        <?php }?>
