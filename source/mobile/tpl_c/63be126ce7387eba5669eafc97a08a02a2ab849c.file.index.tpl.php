<?php /* Smarty version Smarty-3.1.13, created on 2019-01-16 20:58:32
         compiled from "E:\www\dnn\source\mobile\tpl\default\index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:46585c3c5c577cf034-80050219%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '63be126ce7387eba5669eafc97a08a02a2ab849c' => 
    array (
      0 => 'E:\\www\\dnn\\source\\mobile\\tpl\\default\\index.tpl',
      1 => 1547643496,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '46585c3c5c577cf034-80050219',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_5c3c5c578861d6_94566721',
  'variables' => 
  array (
    '_SPATH' => 0,
    'wcjssdkconfig' => 0,
...
<?php if ($_valid && !is_callable('content_5c3c5c578861d6_94566721')) {function content_5c3c5c578861d6_94566721($_smarty_tpl) {?>
...
coordTransform.js" type="text/javascript" charset="utf-8"></script>
  <script type="text/javascript">
    ...
    bui.ready(function(){
      ...
      var point = new BMap.Point(113.299263,23.095762);
...
icons/icon_person.png", new BMap.Size(32,32)) //定位的icon图标
              });
          ...
          html +=`<li id="vehicle_${el.id}" class="bui-btn bui-box" onclick="viewVehicle(${el.id})">
            <div class="Vehicle_info_box">
              ...
              <div class="info_text">
                ...
                <div><span>电量${el.quantity}</span><span>续航${el.endurance}</span></div>
                <p>距离约${distance}km</p>
              </div>
            </div>
          </li>`;
...
index.html",
            ...
            if(res.error == 0){
              var str = '<div class="img"><img src="'+res.result.picfilepath+'" /></div><div class="text"><h3>'+res.result.platenumber+'</h3><h5>（含保险）</h5><div class="info"><span>电量:'+res.result.quantity+'</span><span>续航:'+res.result.endurance+'</span><span>座位:'+res.result.seat+'人</span></div><div class="price"><p><i><b>'+res.result.startmileage+'</b>公里内</i><span>'+res.result.startmoney+'</span>元/起步(含里程+时间)</p><p><i><b>'+res.result.startmileage+'</b>公里外</i><span>'+res.result.mileagemoney+'</span>元/公里+<span>'+res.result.minutemoney+'</span>元/分钟</p></div></div>';
...
index.html",
            ...
            if(res.error == 0){
              ...
              $('#loadbg').show();
              Loading_box.show();
              var socket = new WebSocket('ws://119.29.186.195:19766');
...
cp-userinfo.html";
              ...
              bui.confirm("请先缴纳租车押金!", function (e) {
                var text = $(e.target).text();
                if( text == "确定"){
                  Loading_box.show();
                  window.location.href = "<?php echo $_smarty_tpl->tpl_vars['_SCONFIG']->value['webroot'];?>
