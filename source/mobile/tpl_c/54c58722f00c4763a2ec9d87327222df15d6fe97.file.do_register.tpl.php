<?php /* Smarty version Smarty-3.1.13, created on 2020-12-10 15:59:09
         compiled from "/huidin/web/share_huidin/source/mobile/tpl/default/do_register.tpl" */ ?>
<?php /*%%SmartyHeaderCode:19969867425fd1d54da96293-01444710%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '54c58722f00c4763a2ec9d87327222df15d6fe97' => 
    array (
      0 => '/huidin/web/share_huidin/source/mobile/tpl/default/do_register.tpl',
      1 => 1600835541,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '19969867425fd1d54da96293-01444710',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5fd1d54dafc727_64096844',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fd1d54dafc727_64096844')) {function content_5fd1d54dafc727_64096844($_smarty_tpl) {?><!DOCTYPE HTML>
<html lang="en-US">
<head>
<meta http-equiv="Content-Type" content="text/html;charset=UTF-8" />
<title><?php echo $_smarty_tpl->tpl_vars['_SCONFIG']->value['sitetitle'];?>
 - 会员注册</title>
...
do-login.html" style="margin-top:0.2rem;">如已有账号，立即登录</a>
        </div>
	</main>

    <footer>
        <div class="copyright">
            <?php if ($_smarty_tpl->tpl_vars['_SCONFIG']->value['copyright']){?><p><?php echo $_smarty_tpl->tpl_vars['_SCONFIG']->value['copyright'];?>
</p><?php }?>
            <?php if ($_smarty_tpl->tpl_vars['_SCONFIG']->value['miibeian']){?><p><?php echo $_smarty_tpl->tpl_vars['_SCONFIG']->value['miibeian'];?>
</p><?php }?>
        </div>
    </footer>
...
do-articlepage-op-details-id-4.html",    // 提交到controller的url路径
            ...
            $(".btn-send").on("click",function () {
                ...
                if(!isDisable){
                    ...
                    $.ajax({
                        url: "<?php echo $_smarty_tpl->tpl_vars['_SCONFIG']->value['webroot'];?>
do-register-op-send_sms.html",    // 提交到controller的url路径
                        type: "post",    // 提交方式
            ...
            bui.btn("#register").submit(function (loading) {
               ...
               //false
                ...
                $.ajax({
                    url: "<?php echo $_smarty_tpl->tpl_vars['_SCONFIG']->value['webroot'];?>
do-register-op-regsubmit.html",    // 提交到controller的url路径
                    type: "post",    // 提交方式
