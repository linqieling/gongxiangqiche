<?php /* Smarty version Smarty-3.1.13, created on 2020-12-14 18:18:44
         compiled from "/huidin/web/share_huidin/source/mobile/tpl/default/cp_userinfo.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4714170475fd73c0423a5c2-41474750%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '529512e281604caebb5d38f239c0010f8154f36d' => 
    array (
      0 => '/huidin/web/share_huidin/source/mobile/tpl/default/cp_userinfo.tpl',
      1 => 1600835654,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '4714170475fd73c0423a5c2-41474750',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5fd73c0438fbf3_10666057',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fd73c0438fbf3_10666057')) {function content_5fd73c0438fbf3_10666057($_smarty_tpl) {?>
...
icon_select_avatar.png" /></div>
                        <input type="file"  accept="image/*"  class="upload_input"  data-url="<?php echo $_smarty_tpl->tpl_vars['_SCONFIG']->value['webroot'];?>
cp-userinfo-op-upload_img-type-1.html" data-show="#showimg" data-input="back"  />
                        <input type="hidden" id="back" value="<?php echo $_smarty_tpl->tpl_vars['result']->value['back'];?>
"/>
...
" />
            ...
            <li class="bui-btn bui-box clearactive">
                <label class="bui-label" for="user" style="width: 1.8rem;">有效期开始<b style="color:red;">*</b></label>
                <div class="span1">
                    <div class="bui-input">
                        <input id="startdate" type="date" placeholder="请选择有效期开始时间" autocomplete="off" value="<?php echo $_smarty_tpl->tpl_vars['result']->value['startdate'];?>
" />
                    </div>
                </div>
            </li>
            <li class="bui-btn bui-box clearactive">
                <label class="bui-label" for="user" style="width: 1.8rem;">有效期结束<b style="color:red;">*</b></label>
                <div class="span1">
                    <div class="bui-input">
                        <input id="enddate" type="date" placeholder="请选择有效期结束时间" autocomplete="off" value="<?php echo $_smarty_tpl->tpl_vars['result']->value['enddate'];?>
" />
                    </div>
                </div>
            </li>
            <ul class="bui-list personal-info" style="background: #FFF;border-bottom: 0.02rem solid #eee">
                ...
                <div id="ups_frontage" class="bui-upload bui-fluid-space-1" style="margin-top:0.2rem;">
                    <div class="bui-upload-thumbnail btn upload-container" id="upload-container" style="height: 4rem;">
			            <img id="showimg_frontage" src="<?php if ($_smarty_tpl->tpl_vars['result']->value['front']){?><?php echo picredirect($_smarty_tpl->tpl_vars['result']->value['front']);?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['_SPATH']->value['images'];?>
idcard/front.png<?php }?>" height="100%;" width="auto" />
						<input type="file"  accept="image/*"  class="upload_input"  data-url="<?php echo $_smarty_tpl->tpl_vars['_SCONFIG']->value['webroot'];?>
cp-userinfo-op-upload_img-type-2.html" data-show="#showimg_frontage"  data-input="#front"/>
                        <input type="hidden" id="front" value="<?php echo $_smarty_tpl->tpl_vars['result']->value['front'];?>
"/> 
			        </div>
            ...
            <ul class="bui-list personal-info">
                ...
                <div id="ups_opposite" class="bui-upload bui-fluid-space-1" style="margin-top:0.2rem;">
                    ...
                    <div class="bui-upload-thumbnail btn upload-container" id="upload-container" style="height: 4rem;">
                        <img id="showimg_opposite" src="<?php if ($_smarty_tpl->tpl_vars['result']->value['back']){?><?php echo picredirect($_smarty_tpl->tpl_vars['result']->value['back']);?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['_SPATH']->value['images'];?>
idcard/back.png<?php }?>" height="100%;" width="auto" />
                        <input type="file"  accept="image/*"  class="upload_input"  data-url="<?php echo $_smarty_tpl->tpl_vars['_SCONFIG']->value['webroot'];?>
cp-userinfo-op-upload_img-type-3.html" data-show="#showimg_opposite" data-input="#back"  />
                        <input type="hidden" id="back" value="<?php echo $_smarty_tpl->tpl_vars['result']->value['back'];?>
"/>
                    </div>
...
" />
            ...
            <li class="bui-btn bui-box clearactive">
                <label class="bui-label" for="user">准驾车型<b style="color:red;">*</b></label>
                <div class="span1">
                    <div class="bui-input">
                        <input id="type" type="text" maxlength="10" placeholder="请输入你的准驾车型" value="<?php echo $_smarty_tpl->tpl_vars['result']->value['type'];?>
" />
                    </div>
                </div>
            </li>
            ...
            <ul class="bui-list personal-info" style="background: #FFF;border-bottom: 0.02rem solid #eee">
                ...
                <div id="ups_frontage" class="bui-upload bui-fluid-space-1" style="margin-top:0.2rem;">
                    ...
                    <div class="bui-upload-thumbnail btn upload-container" id="upload-container" style="height: 4rem;">
                        <img id="showimg_frontage" src="<?php if ($_smarty_tpl->tpl_vars['result']->value['front']){?><?php echo picredirect($_smarty_tpl->tpl_vars['result']->value['front']);?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['_SPATH']->value['images'];?>
idcard/dfront.png<?php }?>" height="100%;" width="auto" />
                        <input type="file"  accept="image/*"  class="upload_input"  data-url="<?php echo $_smarty_tpl->tpl_vars['_SCONFIG']->value['webroot'];?>
cp-userinfo-op-upload_img-type-4.html" data-show="#showimg_frontage"  data-input="#front"/>
                        <input type="hidden" id="front" value="<?php echo $_smarty_tpl->tpl_vars['result']->value['front'];?>
"/>
                    </div>
            ...
            <ul class="bui-list personal-info">
                ...
                <div id="ups_opposite" class="bui-upload bui-fluid-space-1" style="margin-top:0.2rem;">
                    ...
                    <div class="bui-upload-thumbnail btn upload-container" id="upload-container" style="height: 4rem;">
                        <img id="showimg_opposite" src="<?php if ($_smarty_tpl->tpl_vars['result']->value['back']){?><?php echo picredirect($_smarty_tpl->tpl_vars['result']->value['back']);?>
<?php }else{ ?><?php echo $_smarty_tpl->tpl_vars['_SPATH']->value['images'];?>
idcard/dback.png<?php }?>" height="100%;" width="auto" />
                        <input type="file"  accept="image/*"  class="upload_input"  data-url="<?php echo $_smarty_tpl->tpl_vars['_SCONFIG']->value['webroot'];?>
cp-userinfo-op-upload_img-type-5.html" data-show="#showimg_opposite"  data-input="#back" />
                        <input type="hidden" id="back" value="<?php echo $_smarty_tpl->tpl_vars['result']->value['back'];?>
"/>
                    </div>
