...
[##if $op eq ''##]
    ...
    <style type="text/css">
        ...
        .nav-list .bui-btn a .icon.icon-balance {
            background: url([##$_SPATH.images##]icons/icon-balance.png) center no-repeat;
            background-size: 100%;
        }
        .nav-list .bui-btn a .icon.icon-deposit {
            background: url([##$_SPATH.images##]icons/icon-deposit.png) center no-repeat;
            background-size: 100%;
        }
        .nav-list .bui-btn a .icon.icon-coupon {
            background: url([##$_SPATH.images##]icons/icon-coupon.png) center no-repeat;
            background-size: 100%;
        }
...
[##elseif $op eq 'balance'##]
    ...
    <script type="text/javascript">
        bui.ready(function(){
            ...
            var uiList = bui.list({
                id: "#balanceList",
                url: "[##$_SCONFIG.webroot##]cp-userpurse-op-balance_list.html",
                method: 'POST',
                pageSize: 10,
                data: {},
                field: {
                ...
                callback: function (e) {
                    ...
                    if( text == "确定"){
                        ...
                        if (type == 2) {//提现
                            ...
                            Loading_box.show();
                            bui.ajax({
                                url: "[##$_SCONFIG.webroot##]cp-userpurse-op-balance_recharge.html",
                                method: 'POST',
                                async: true,
                                data: {
                                    'random': Math.random(),
    ...
    <script type="text/javascript">
        bui.ready(function(){
            ...
            $('#detailed_btn').on('click', function () {
                ...
                var uiList = bui.list({
                    id: "#depositList",
                    url: "[##$_SCONFIG.webroot##]cp-userpurse-op-deposit_list.html",
                    method: 'POST',
                    pageSize: 10,
                    data: {},
                    field: {
            ...
            bui.btn("#pay_btn").submit(function (loading) {
                ...
                Loading_box.show();
                bui.ajax({
                    url: "[##$_SCONFIG.webroot##]cp-userpurse-op-deposit_recharge.html",
                    method: 'POST',
                    async: true,
            ...
            var uiDialog = bui.dialog({
                ...
                callback: function(e) {
                    ...
                    if (text == '确定') {
                        ...
                        Loading_box.show();
                        bui.ajax({
                            url: "[##$_SCONFIG.webroot##]cp-userpurse-op-deposit_return.html",
                            method: 'POST',
                            async: true,
            ...
            $("#return_btn").on("click", function () {
                ...
                Loading_box.show();
                bui.ajax({
                    url: "[##$_SCONFIG.webroot##]cp-userpurse-op-coupon_total.html",
                    method: 'POST',
                    async: true,
                    data: {'random': Math.random()}
                }).then(function(res){
...
[##elseif $op eq 'coupon'##]
    ...
    <style type="text/css">
        ...
        * {
        ...
        .list_price_border {
            background-image: url([##$_SPATH.images##]icon-circle.png);
        ...
        .list_content.status0 {
            background: url([##$_SPATH.images##]coupon_status0_bg.png) top right no-repeat;
            background-size: 1.28rem;
        }
        .list_content.status1 {
            background: url([##$_SPATH.images##]coupon_status1_bg.png) top right no-repeat;
            background-size: 1.28rem;
        }
        .list_content.status2 {
            background: url([##$_SPATH.images##]coupon_status2_bg.png) top right no-repeat;
            background-size: 1.28rem;
        }
        .list_content.status3 {
            background: url([##$_SPATH.images##]coupon_status3_bg.png) top right no-repeat;
            background-size: 1.28rem;
        }
        ...
        .text_btn .icon {
            ...
            border: none;
            float: left;
            background-image: url([##$_SPATH.images##]icon-dowm.png);
            background-size: 100%;
    ...
    <script type="text/javascript">
        ...
        　　});
            ...
            function getData (page,pagesize,command) {
                ...
                bui.ajax({
                    url: "[##$_SCONFIG.webroot##]cp-userpurse-op-coupon_list.html",
                    method: "POST",
                    data: {
                        status: state,
                        page: page,
            ...
            function getOverdue (id) {
                if(id){
                    bui.ajax({
                        url: "[##$_SCONFIG.webroot##]cp-userpurse-op-coupon_overdue.html",
                        method: 'POST',
                        async: true,
                        data: {id:id}
                    }).then(function(res){
            ...
            viewCoupon = function (id) {
                if(id){
                    bui.ajax({
                        url: "[##$_SCONFIG.webroot##]cp-userpurse-op-coupon_content.html",
                        method: 'POST',
                        async: true,
                        data: {id:id}
                    }).then(function(res){
