    ...
    <style type="text/css">
        ...
        .pay {
         ...
         .wxpay-icon{
            ...
            border: none;
            float: left;
            background-image: url([##$_SPATH.images##]icons/wechat.png);
            background-size: 100%;
         ...
         .alipay-icon{
            ...
            border: none;
            float: left;
            background-image: url([##$_SPATH.images##]icons/alipay.png);
            background-size: 100%;
            background-repeat: no-repeat;
         }
        ...
        <div class="bui-list">
            <div class="bui-btn bui-box ">
                <div class="personal-img">
                    <img src="[##if $result.picfilepath##][##picredirect($result.picfilepath)##][##else##][##$_SPATH.images##]icon_cehicle.png[##/if##]" style="margin-top: -2rem;">
                </div>
            </div>
            <div class="bui-list">
                <div class="bui-btn bui-box">
                    <div class="span1 platenumber">
                        <p>[##$result.platenumber##]</p>
                    </div>
                    <div class="span1">
                        <p class="item-text">
  ...
  <script type="text/javascript">
    ...
    bui.ready(function () {
        ...
        function getData (page,pagesize,command) {
            ...
            bui.ajax({
                url: "[##$_SCONFIG.webroot##]cp-orderdetailspay-op-coupon_list.html",
                method: "POST",
                data: {
                  'random': Math.random(),
            ...
            if(id){
                bui.ajax({
                    ...
                    if(result.status == 4){
                        ...
                        var paymoney=parseFloat([##$result.paymoney##]);//付款总额
                        var oldcoupon = parseFloat([##$result.totalmoney-$result.paymoney##]);//原优惠金额
        ...
        bui.btn("#pay_btn").submit(function (loading) {
            ...
            PayLoading.show();
            bui.ajax({
                url: "[##$_SCONFIG.webroot##]cp-orderdetailspay-op-pay.html",
                method: 'POST',
                async: true,
                data: {
                    'id': '[##$result.id##]',
                ...
                if(res.error == 0){
                    if(paytype==2){
                        ...
                        setTimeout(function() {
                            window.location.href='[##$_SCONFIG.webroot##]cp-orderdetails-id-[##$result.id##].html';
                        }, 1500);
                    }
                }else{
                    $('#loadbg').hide();
