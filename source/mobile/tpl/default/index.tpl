...
[##include file='head.tpl'##][##*头部文件*##]
  ...
  <style type="text/css">
    ...
    .VehicleDetailed_close {
      ...
      width: 0.64rem;
      height: 0.64rem;
      background: url([##$_SPATH.images##]VehicleDetailed_close.png) center no-repeat;
      background-size: 100%;
    }
    ...
    #SiteNavigation>a {
      ...
      background: url([##$_SPATH.images##]icons/icon_navigation.png) center no-repeat;
  ...
  <script type="text/javascript">
    bui.ready(function(){
      ...
      [##if $siteData##]
      var point = new BMap.Point([##$siteData.lng##],[##$siteData.lat##]);
      [##else##]
      ...
      wx.config({
        ...
        appId: '[##$wechatdata.wxappid##]', // 必填，公众号的唯一标识
        timestamp: '[##$wcjssdkconfig.timestamp##]', // 必填，生成签名的时间戳
        nonceStr: '[##$wcjssdkconfig.nonceStr##]', // 必填，生成签名的随机串
        signature: '[##$wcjssdkconfig.signature##]',// 必填，签名，见附录1
        jsApiList: [
          'checkJsApi',
          'getLocation'
        ] // 必填
      ...
      wx.ready(function(){
          ...
          success : function(res) {
            if(res.checkResult.getLocation){
              ...
              var geolocationControl = new BMap.GeolocationControl({    
                ...
                , locationIcon: new BMap.Icon("[##$_SPATH.images##]icons/icon_person.png", new BMap.Size(15,15)) //定位的icon图标
              });
        ...
        wx.getLocation({
          ...
          success: function (res) {
            ...
            //创建定位标注
            var siteIcon = new BMap.Icon("[##$_SPATH.images##]icons/icon_person.png", new BMap.Size(15,15));
      ...
      function setPlace(){
        ...
        function myFuns(){
          ...
          var siteIcon = new BMap.Icon("[##$_SPATH.images##]icons/icon_location.png", new BMap.Size(32,32));
      ...
      function AddSiteList(){
        Loading_box.show();
        bui.ajax({
          url: "[##$_SCONFIG.webroot##]index.html",
          method: 'POST',
          data: {
            'random': Math.random(),
            'op': 'site_list'
          ...
          if(res.error == 0){
            $.each(res.result, function(k,v){
              var marker_site = new BMap.Marker(new BMap.Point(v['lng'], v['lat']),{icon:new BMap.Icon("[##$_SPATH.images##]icons/icon_site.png", new BMap.Size(42,42))});
      ...
      toNavigation = function (that){
        ...
        var walking = new BMap.WalkingRoute(map, {
          ...
          onMarkersSet:function(routes) {
            var startIcon = new BMap.Icon("[##$_SPATH.images##]icons/icon_navigation_start.png", new BMap.Size(42,42));
            var endIcon = new BMap.Icon("[##$_SPATH.images##]icons/icon_navigation_end.png", new BMap.Size(42,42));
      ...
      endNavigation = function(that){
        ...
        AddSiteList();
        var userinfo = storage.get("userinfo");
        var siteIcon = new BMap.Icon("[##$_SPATH.images##]icons/icon_person.png", new BMap.Size(32,32));
          ...
          bui.ajax({
            ...
            if(res.error == 0){
              ...
              socket.onopen = function() {
                ...
                setTimeout(function() {
                  window.location.href = '[##$_SCONFIG.webroot##]cp-orderdetails-id-'+res.result+'.html';
                }, 10);
              };
              ...
              bui.confirm("请先登录或注册账号!", function (e) {
                ...
                if( text == "确定"){
                  Loading_box.show();
                  window.location.href = "[##$_SCONFIG.webroot##]do-login.html";
                }else{
                  $('.vehicle_btn').css('pointer-events','auto');
                }
              });
              ...
              bui.confirm("请先认证身份信息!", function (e) {
                ...
                if( text == "确定"){
                  Loading_box.show();
                  window.location.href = "[##$_SCONFIG.webroot##]cp-userinfo-op-user_idcard.html";
                }else{
                  $('.vehicle_btn').css('pointer-events','auto');
                }
              });
              ...
              bui.confirm("请先认证驾驶信息!", function (e) {
                ...
                if( text == "确定"){
                  Loading_box.show();
                  window.location.href = "[##$_SCONFIG.webroot##]cp-userinfo-op-user_drive.html";
                }else{
                  $('.vehicle_btn').css('pointer-events','auto');
                }
              });
              ...
              bui.confirm(res.msg, function (e) {
                ...
                if( text == "确定"){
                  Loading_box.show();
                  window.location.href = "[##$_SCONFIG.webroot##]cp-userpurse-op-deposit.html";
                }else{
                  $('.vehicle_btn').css('pointer-events','auto');
                }
              });
              ...
              bui.confirm("未检测到微信账号信息,是否重新获取?", function (e) {
                ...
                if( text == "确定"){
                  Loading_box.show();
                  window.location.href = "[##$_SCONFIG.webroot##]index-wcauthorize-op-getcode.html";
                }else{
                  $('.vehicle_btn').css('pointer-events','auto');
                }
              });
