                ...
                <div class="bui-upload bui-fluid-space-2" style="margin-top:0.2rem;">
                    <div class="span1" id="ups_front_right">
                        <div class="bui-upload-thumbnail upload-container" style="height: 2rem; border-radius: 0.1rem; overflow: hidden;">
                            ...
                            <input type="file"  accept="image/*" capture="camera"  class="upload_input"  data-url="[##$_SCONFIG.webroot##]cp-orderbefore-op-upload_img-oid-[##$oid##]-type-front_right.html" data-show="#showimg_front_right" data-input="#front_right"  />
                     ...
                     <div class="span1" id="ups_front_left">
                        <div class="bui-upload-thumbnail upload-container" style="height: 2rem; border-radius: 0.1rem; overflow: hidden;">
                            ...
                            <input type="file"  accept="image/*"  capture="camera" class="upload_input"  data-url="[##$_SCONFIG.webroot##]cp-orderbefore-op-upload_img-oid-[##$oid##]-type-front_left.html" data-show="#showimg_front_left" data-input="#front_left"  />
                ...
                <div class="bui-upload bui-fluid-space-2" style="margin-top:0.2rem;">
                    <div class="span1" id="ups_rear_right">
                        <div class="bui-upload-thumbnail upload-container" style="height: 2rem; border-radius: 0.1rem; overflow: hidden;">
                            ...
                            <input type="file"  accept="image/*" capture="camera"  class="upload_input"  data-url="[##$_SCONFIG.webroot##]cp-orderbefore-op-upload_img-oid-[##$oid##]-type-rear_right.html" data-show="#showimg_rear_right" data-input="#rear_right"  />
                    ...
                    <div class="span1" id="ups_rear_left">
                        <div class="bui-upload-thumbnail upload-container" style="height: 2rem; border-radius: 0.1rem; overflow: hidden;">
                            ...
                            <input type="file"  accept="image/*" capture="camera"  class="upload_input"  data-url="[##$_SCONFIG.webroot##]cp-orderbefore-op-upload_img-oid-[##$oid##]-type-rear_left.html" data-show="#showimg_rear_left" data-input="#rear_left"  />
            ...
            <ul class="bui-list personal-info">
                ...
                <div id="morePhoto_box" class="bui-upload bui-fluid-space-4">
                    ...
                    <div class="span1" id="morePhoto">
                        ...
                        <input type="file"  accept="image/*" capture="camera"  class="upload_more"  data-url="[##$_SCONFIG.webroot##]cp-orderbefore-op-upload_img-oid-[##$oid##]-type-more_upload.html"  data-show="#morePhoto_box"/>
                        </div>
                    </div>
                </div>
            </ul>
    ...
    <script type="text/javascript">
        bui.ready(function () {
            ...
            bui.btn("#submit").submit(function(loading) {
                ...
                Loading_box.show();
                $.ajax({
                    url: "[##$_SCONFIG.webroot##]cp-orderbefore-op-post.html",
                    type: "post",
                    data: {
                        "random": Math.random(),
                        "oid": oid,
