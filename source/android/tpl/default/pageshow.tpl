    ...
    <div id="con">
      <div style="width:100%; overflow:hidden; background-color:#FFF; margin:0px;">
        <div style="width:96%; overflow:hidden; margin:10px auto; ">
          <!--<div style="text-align:center; font-size:18px; border-bottom:1px solid #dfdfdf; padding-bottom:10px; padding-top:5px;">[##$result.catname##]</div>-->
          <div id="content" style="line-height:180%;">[##$result.content##]</div>
        </div>
      </div>
    </div>
  </div>
