...
//注册表单验证
  ...
  <div id="container" style="margin-top:40px;">
    ...
    <ul style="width: 100%; overflow: hidden; background: #FFF; text-align: center; color: #333; font-size: 16px;">
       <li><a style="width: 50%; float: left; height: 0.4rem; line-height: 0.4rem; font-size:12px;  border-bottom: solid 2px #0088fe;" href="[##$_SCONFIG.webroot##]do-register.html">普通注册</a></li>
      <li><a style="width: 50%;float: left;   height: 0.4rem; line-height: 0.4rem; font-size:12px;"  href="[##$_SCONFIG.webroot##]do-register_mobile.html">手机注册</a></li>
  </ul>
       ...
       <form id="register_user" name="form1" method="post" action="[##$_SCONFIG.webroot##]do-register.html"> 
        ...
        <div class="input_box" style="position: relative;"> <em class="code-icon"></em>
          <input type="text" name="seccode" id="seccode" maxlength="15" placeholder="验证码"/>
              <em style="position: absolute; top: 18%; right: 0.1rem;"> [##include file='seccode.tpl'##]</em>
        </div>
