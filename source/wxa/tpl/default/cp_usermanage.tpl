...
<div id="container">
  ...
  <div class="weui_cells weui_cells_access" style="margin-top:10px; margin-bottom:60px;">
    <a class="weui_cell" href="[##$_SCONFIG.webroot##]index-index-op-exit.html">
        <div class="weui_cell_hd"><img src="[##$_SPATH.path##]images/icon_tab06.png" alt="" style="width:20px;margin-right:5px;display:block"></div>
        <div class="weui_cell_bd weui_cell_primary">
            <p>安全退出</p>
        </div>
        <div class="weui_cell_ft"></div>
