...
<link rel="stylesheet" href="[##$_SPATH.css##]style.css" type="text/css">
<link rel="stylesheet" href="[##$_SPATH.path##]awesome/css/font-awesome.min.css">
<link rel="stylesheet" href="[##$_SPATH.path##]awesome/css/font-awesome-ie7.min.css">
<link rel="stylesheet"  href="[##$_SPATH.path##]weui/dist/style/weui.css" type="text/css">
...
<script type="text/javascript" src="[##$_SPATH.js##]jweixin-1.3.2.js"></script>
</head>
<body>