<table cellspacing="0" cellpadding="20">
	...
	<table width="500" cellspacing="0" cellpadding="1">
		<tr><td bgcolor="#000" align="left" style="font-family:'lucida grande',tahoma,'bitstream vera sans',helvetica,sans-serif;line-height:150%;color:#FFF;font-size:24px;font-weight:bold;padding:4px">&nbsp; [##$_SCONFIG.sitename##]</th></tr>
		<tr><td bgcolor="#000">
			<table width="100%" cellspacing="0" bgcolor="#FFFFFF" cellpadding="20">
				<tr><td style="font-family:'lucida grande',tahoma,'bitstream vera sans',helvetica,sans-serif;line-height:150%;color:#000;font-size:14px;">
					...
					<br><a href="[##$_SCONFIG.siteallurl##]" target="_blank">[##$_SCONFIG.siteallurl##]</a>
					<br>[##$timestamp|date_format:"%Y-%m-%d %H:%M:%S"##]
					<br>
